...
!(function () {
  ...
  var o = i(
      ...
      M(L, t, { solid: "fass", regular: "fasr", light: "fasl" }),
      L)
    ),
    H =
      (i(
        ...
        M(l, t, { fass: "fa-solid", fasr: "fa-regular", fasl: "fa-light" }),
        l)
      ),
      i(
        (M((c = {}), h, {
      ...
      i(
        ...
        M(s, t, { 900: "fass", 400: "fasr", 300: "fasl" }),
        s)
      ),
  ...
  function u(c, s, l) {
    var z = (2 < arguments.length && void 0 !== l ? l : {}).skipHooks,
      l = void 0 !== z && z,
      z = d(s);
    "function" != typeof v.hooks.addPack || l
      ? (v.styles[c] = e(e({}, v.styles[c] || {}), z))
      : v.hooks.addPack(c, d(s)),
      "fas" === c && u("fa", s);
  }
  var g = {
    "trash-can": [
